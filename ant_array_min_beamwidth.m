...
% ARRAY_GEOMETRY = '1D_UNIFORM _LINE';
% ARRAY_GEOMETRY = '2D_UNIFORM _LATTICE';
...
max_halfbeam = 50;   % starting half beamwidth (must be feasible)
...
%********************************************************************
elseif strcmp( ARRAY_GEOMETRY, '1D_UNIFORM _LINE' )
...
%********************************************************************
elseif strcmp( ARRAY_GEOMETRY, '2D_UNIFORM _LATTICE' )
  m = 6; n = m^2;
  d = 0.45*lambda;
...
theta_ 1 = theta_tar+halfbeam;
theta_ 2 = theta_tar-halfbeam;
plot([0 55*cos(theta_tar*pi/180)], [0 55*sin(theta_tar*pi/180)], 'k:')
plot([0 55*cos(theta_ 1*pi/180)], [0 55*sin(theta_ 1*pi/180)], 'k:')
plot([0 55*cos(theta_ 2*pi/180)], [0 55*sin(theta_ 2*pi/180)], 'k:')
hold off
